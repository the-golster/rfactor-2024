...
public class SwerveModuleState2 extends SwerveModuleState
{
     ...
     * omega per sec
     */
    public double omegaPerSecond = 0;
     ...
     * @param omegaPerSecond    The angular velocity of the module.
     */
    public SwerveModuleState2(
            double speedMetersPerSecond, Rotation2d angle, double omegaPerSecond)
    {
        super(speedMetersPerSecond, angle);
        this.omegaPerSecond = omegaPerSecond;
    }
     ...
     * @param omegaPerSecond Module wheel angular rotation in radians per second.
     */
    public SwerveModuleState2(SwerveModuleState state, double omegaPerSecond)
    {
    ...
    {
        SwerveModuleState2 optimized = new SwerveModuleState2(SwerveModuleState.optimize(desiredState, currentAngle), desiredState.omegaPerSecond);
